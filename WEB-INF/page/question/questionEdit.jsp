  ...
  <body>
    <form id="form" method="post">
        ...
        <fieldset style="border:solid 1px #aaa;padding:10px;">
            ...
            <tr>
               ...
               <tr>
                    <td style="width:50px;">答案（参考答案）：</td>
                    <td style="width:150px;">
                        <textarea id="answer-editor" name="answer-editor" emptyText="请输入" onvaluechanged="editorChange"></textarea>
                    </td>
                </tr>
                
               <tr style="display:none;">
                    <td style="width:70px;">答案正文：</td>
                    <td style="width:150px;">
                    	<textarea name="answer" id="answer" class="mini-textarea"></textarea>
                    </td>
                </tr>
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
        	...
        	setDataForEditor(editorAnswer,"answer-editor","answer");

			var o = form.getData();
			if((o.rank==3&&o.type!=2)||(o.type==2&&o.rank!=3)){
				mini.alert("单选多选不要选错啊");
				return;
			}
