  ...
  <%@ include file="/base/jsp/background.jsp"%>
   ...
   <div id="content-wrapper" class="content-wrapper clear">
    <div id="content-wrapper" class="content-wrapper clear">
         ...
         <p>1、	王同学 15105199936    </p>
         <p>2、	发送邮件到 imsearch2016@163.com</p>
         <p>3、   技术问题请联系：QQ 1400174067</p>
<!--<p>1、	关注微信公众号：njuxinguan</p>
<p>2、	微博<a href="http://weibo.com/infomanage" target="_blank">@南京大学信息管理学院</a> （唯一官方认证哦）</p>
<p>3、	发送邮件到imsearch2015@163.com</p>
<p>4、	电话或是短信联系：石同学  18362925313     &nbsp; &nbsp; &nbsp;冀同学  18795858196</p>
-->
         </div>  
