...
//	private static String password = CoreConstants.getProperty("mail.pwd");// 发件人密码
	...
	public static boolean sendMail(String to,String subject,String content) throws UnsupportedEncodingException, MessagingException{
	 ...
	 */
	public static boolean sendMail(String to,String subject,String content,String filename,Vector file) throws UnsupportedEncodingException, MessagingException {
		// 构造mail session
		Properties props = new Properties();
		props.put("mail.smtp.auth", "true");
		Session session = Session.getDefaultInstance(props, new Authenticator() {
			public PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication(ConstantResources.MAILUSERNAME, ConstantResources.MAILPASSWORD);
			}
		});
		
			// 构造MimeMessage 并设定基本的值
			MimeMessage msg = new MimeMessage(session);
			msg.setFrom(new InternetAddress(ConstantResources.MAILUSERNAME,ConstantResources.MAILFROM));
			...
			transport.connect(ConstantResources.MAILHOST, ConstantResources.MAILUSERNAME, ConstantResources.MAILPASSWORD);
